...
class NewsController extends PublicController
{
	public function index()
    {
		...
		$this->display($this->template . 'News/index');
    }
	public function show()
    {
        ...
        if (empty($previous_page)) {
			...
			$previous_page['url'] = U('News/show',array('id' => $previous_page['id']));
        ...
        if (empty($next_page)) {
			...
			$next_page['url'] = U('News/show',array('id' => $next_page['id']));
        ...
        /*评论列表end*/
        /*模板start*/
        $this->display($this->template . 'News/show');
        /*模板end*/
    }
	/*
