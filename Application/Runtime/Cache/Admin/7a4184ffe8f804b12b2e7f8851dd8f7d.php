            ...
            <div class="List">
                ...
                <?php if(is_array($article_list)): foreach($article_list as $k=>$vo): ?><div class="ProList">
                        <ul>
                            ...
                            <li class="Name"><a href="<?php echo U('Article/edit',array('id'=>$vo['id']));?>"><?php echo (str_cut($vo["title"],80)); ?></a></li>
                            ...
                            <li class="Oper">
                                <div>
                                    ...
                                    <span>|</span>
                                    <a href="<?php echo U('Article/status',array('id'=>$vo['id'],'status'=>$vo['status']));?>" onclick="return confirm('确认是否删除?')">删除</a>
                                </div>
                            </li>
                        </ul>
