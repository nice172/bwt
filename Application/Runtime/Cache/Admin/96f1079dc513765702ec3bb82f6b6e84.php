...
<block name="body">
    ...
    <div class="content">
        ...
        <form action="<?php echo U('Banner/listorder');?>" method="post" >
            <div class="List">
                <div class="table-list">
                    <ul>
                        <li class="ID">ID</li>
                        <li class="Name">幻灯片名称</li>
                        <li class="Property">类型</li>
                ...
                <?php if(is_array($list)): foreach($list as $k=>$vo): ?><div class="ProList">
                        <ul>
                            ...
                            <li class="Name"><a href="<?php echo U('Banner/edit',array('id'=>$vo['id']));?>"><?php echo (str_cut($vo["name"],80)); ?></a></li>
                            <li class="Property">
                                <?php if($vo['cid'] == 0): ?>首页幻灯片
                                <?php elseif($vo['cid'] == 1): ?>
                                	品牌商标
                                <?php elseif($vo['cid'] == 2): ?>
                                	首页广告图<?php endif; ?>
                            ...
                            <li class="Status"><?php echo ($vo['ishidden']==0?'显示':'关闭'); ?></li>
                            <li class="Oper">
                                <div>
                                    <a href="<?php echo U('Banner/edit',array('id'=>$vo['id']));?>">编辑</a>
                                    <span>|</span>
                                    <a href="<?php echo U('Banner/delete',array('id'=>$vo['id']));?>"  onclick="return confirm('确认是否删除?')">删除</a>
                                </div>
                            </li>
                        </ul>
