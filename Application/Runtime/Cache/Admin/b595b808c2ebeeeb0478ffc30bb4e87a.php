...
<?php if($config['pattern'] == 1): ?><div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <?php if(is_array($menuList)): foreach($menuList as $key=>$val): ?><li>
                        <a href="#">
                        ...
                        <ul class="nav nav-second-level collapse">
                            <?php if(is_array($val['child'])): foreach($val['child'] as $key=>$va): ?><li><a href="<?php echo U($va['url']);?>" class="J_menuItem"><?php echo ($va["name"]); ?></a></li><?php endforeach; endif; ?>
                        </ul>
        ...
        <div class="sidebar-inner slimscrollleft">
            <div id="sidebar-menu">
                <ul>
                    ...
                    <?php if(is_array($menuList)): foreach($menuList as $key=>$val): ?><li class='has_sub'>
                            <a href='javascript:void(0);'><i class='fa <?php echo ($val["icon"]); ?>'></i><span><?php echo ($val["name"]); ?></span><span class="pull-right"><i class="fa fa-angle-down"></i></span></a>
                            <ul>
                                <?php if(is_array($val['child'])): foreach($val['child'] as $key=>$va): ?><li><a href="<?php echo U($va['url']);?>"><span><?php echo ($va["name"]); ?></span></a></li><?php endforeach; endif; ?>
                            </ul>
                        </li><?php endforeach; endif; ?>
                </ul>
