                ...
                <div id=cpxqcon>
                    ...
                    <div id="cpxqtagContent"> 
                        <div class="cpxqtagContent selectTag" id="cpxqtagContent0" style="display:block;">
                            ...
                            <ul>
                                ...
                                <li class="input">
                                    ...
                                    <div class="radio"><span><input type="radio" name="ismodel" value="6" <?php if($detail['ismodel'] == 6): ?>checked="checked"<?php endif; ?>></span><label for="ismodel6">链接</label></div>
                                </li>
                            </ul>
                            <ul>
                        ...
                        <div class="cpxqtagContent" id="cpxqtagContent2">
                        	<ul>
                                <li class="Name">简介</li>
                                <li class="input"><textarea name="info" class="common-textarea textarea"  cols="30" style="width: 50%;" rows="5"><?php echo unsafe_replace($detail['info']);?></textarea></li>
                            </ul>
                            <ul>
